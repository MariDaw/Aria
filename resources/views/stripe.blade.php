            ...
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        <h3 class="panel-title display-td text-3xl">Payment Details</h3>
                        <div class="display-td">
                            <img class="img-responsive pull-right" src="img/favicon.png">
                ...
                <div class="panel-body">
                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block bg-black border-black hover:bg-green-600 hover:text-black hover:border-black" type="submit">Pay Now ({{$precio}}&euro;)</button>
                            </div>
